...
int main() {
    ...
    cout << "Количество элементов массива: "; cin >> nn; se(nn, n); for (int i = 0; i < stoi(nn); ++i) { compare ++; }
    ...
    for (int i = 0; i < stoi(nn); ++i) { compare+=3; }
    for (int i = 0; i < stoi(nn); ++i) { compare+=9; }
    for (int i = 0; i < stoi(nn); ++i) { compare+=9; }
    for (int i = 0; i < stoi(nn); ++i) { svap ++; }
    for (int i = 0; i < stoi(nn); ++i) { svap ++; }
